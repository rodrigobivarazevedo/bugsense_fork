export const securityQuestions = (t: (key: string) => string) => {
  return [
...
export const validateSecurityQuestionsForUpdate = (
  ...
  if (questions.security_question_1 !== originalQuestions.security_question_1) {
    changedQuestions.push({
      question: questions.security_question_1,
      answer: questions.security_answer_1,
    });
  }
  if (questions.security_question_2 !== originalQuestions.security_question_2) {
    changedQuestions.push({
      question: questions.security_question_2,
      answer: questions.security_answer_2,
    });
  }
  if (questions.security_question_3 !== originalQuestions.security_question_3) {
    changedQuestions.push({
      question: questions.security_question_3,
      answer: questions.security_answer_3,
    });
  }
...
export const formatSecurityQuestionsForAPI = (
